...
public class SalesforceOpportunity {
   ...
   // Close the Browser
	...
	public static void main(String[] args) throws InterruptedException {
	    ...
	    //Click on Opportunity tab
		WebElement accounts = driver.findElement(By.xpath("//a[@title='Opportunities']/span[text()='Opportunities']"));
		...
		//Enter 'your name' as opportunity name
		driver.findElement(By.xpath("//input[@name='Name']")).sendKeys("Sreevidya");
		Thread.sleep(2000);
		
		//Select Close Date
		driver.findElement(By.xpath("//input[@name='CloseDate']")).click();
		driver.findElement(By.xpath("//table[@class='slds-datepicker__month']//span[text()='20']")).click();
		
		Thread.sleep(2000);
		
		//Select Stage
		driver.findElement(By.xpath("(//label[text()='Stage']/following::button)[1]")).click();
		driver.findElement(By.xpath("//lightning-base-combobox-item//span[text()='Qualification']")).click();
		Thread.sleep(2000);
